...
public class Desafio {
	...
	public static void main(String[] args) {
		// Ler o valor de uma conta, adcionar a quantidade de pagantes, o valor que alguem irá pagar a mais e deixar o resto para dividir
		...
		System.out.println("Quantas pessoas irão pagar?");
		...
		if(controle.equals("yes") || controle.equals("sim") || controle.equals("y") || controle.equals("s") ) {
			...
			System.out.println(String.format("O valor total é de %.2f, ficando R$:%.2f para cada", valor, valorUnitario));
		}
